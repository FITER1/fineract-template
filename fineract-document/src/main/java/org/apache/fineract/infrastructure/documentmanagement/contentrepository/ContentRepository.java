...
public interface ContentRepository {
    ...
    String saveImage(InputStream uploadedInputStream, Long resourceId, String imageName, Long fileSize, String entityName);

    String saveImage(Base64EncodedImage base64EncodedImage, Long resourceId, String imageName, String entityName);
